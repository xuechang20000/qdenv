...
<div id="datagrid" class="mini-datagrid" style="width: 100%;height: 150px;" allowResize="true" pageSize="10"
    ...
    <div property="columns">
        ...
        <div field="wft012" width="200" headerAlign="center" >发票抬头</div>
        <div field="wft013" width="40" headerAlign="center" >税号</div>
        <div field="wft018" width="80" headerAlign="center" >开户行</div>
        <div field="wft019" width="80" headerAlign="center" >账号</div>
        <div field="aac147" width="80" headerAlign="center" >身份证号</div>
        <div field="wft014" width="80" headerAlign="center" >开票金额</div>
        <div field="wft017" width="80" headerAlign="center" >发票号</div>
        <div field="aae006" width="80" headerAlign="center" >地址</div>
        <div field="aae005" width="80" headerAlign="center" >电话</div>
        <div field="aae016" width="80" headerAlign="center" >有效标志</div>
    ...
    <table>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input id="wft020"  name="wft020" style="width:300px" visible="false" class="mini-textbox"  />
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            ...
            <td align="left">
                <input id="wft014"  name="wft014"  style="width:200px" class="mini-textbox"  />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td align="left">
                <input id="wft016"  name="wft016" enabled="false"  style="width:200px" class="mini-textbox"  />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td align="left">
                <input id="wft017"  name="wft017" enabled="false"  style="width:200px" class="mini-textbox"  />
            </td>
        </tr>
        <tr>
            <td align="right">
...
<script type="text/javascript">
    ...
    function loadWt() {
        ...
        Web.util.request(url,'post',{wat001:wat001},function (data) {
            ...
            wft001=data[0].wft002;
            url="${pageContext.request.contextPath}/work/f100201/queryWt07List"
            Web.util.request(url,"post",{wft001:wft001},function (data1) {
                if (data1.length>0){
                    var i=0;
                    for (var d;d=data1[i++];){
                        grid.addRow({wft020:d.wft020,wft012:d.wft012,wft013:d.wft013,wft014:d.wft014,wft018:d.wft018,
                            wft019:d.wft019,aac147:d.aac147,aae016:d.aae016,aae006:d.aae006,
                            aae005:d.aae005,wft017:d.wft017,aae013:d.aae013})
                    }
                }
                mini.get("aae006").setValue(data.daw005);
                mini.get("aae005").setValue(data.daw004);
            })
        })
    }
