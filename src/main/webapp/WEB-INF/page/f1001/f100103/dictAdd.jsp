    ...
    <table  class="form-table">
        ...
        <tr>
            ...
            <td class="form-td-odd">
                <input id="dictCode"  name="dictCode" class="mini-textbox" style="width:200px;" required="true" onvalidation="onEnglishAndNumberValidation"/>
            </td>
        </tr>
        <tr>
            <td class="form-td-even">
    ...
    function submitForm() {
        ...
        if (form.isValid() == false) {
            ...
            return;
                ...
                //提交表单数据
                var url = '<%=request.getContextPath()%>/admin/addAppDict';
                var form = new mini.Form("#form1");
