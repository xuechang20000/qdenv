...
<div id="form1" >
    ...
    <table>
        ...
        <tr>
            ...
            <td align="left">
                <input id="wft014"  name="wft014" vtype="float" style="width:200px" class="mini-textbox"  />
            </td>
            <td align="right">
                <label for="wft016">开票时间：</label>
            </td>
            <td align="left">
                <input id="wft016"  name="wft016" class="mini-datepicker" style="width: 200px;"
                       format="yyyy-MM-dd" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><a class="mini-button" href="javascript:doSubmit();" id="doSubmit"  iconCls="icon-save" >保存</a>
                &nbsp;&nbsp;<a class="mini-button" href="javascript:doReset();" id="doReset"  iconCls="icon-redo" >重置</a></td>
        </tr>
    </table>
</div>
