    ...
    <table  class="form-table">
        ...
        <tr>
            ...
            <td class="form-td-odd">
                <input id="bmz001"  name="bmz001" class="mini-textbox" visible="false" required="true" />
...
<script type="text/javascript">
    ...
    function loadForm() {
        var url="<%=request.getContextPath()%>/work/f100604/queryBz06List";
      Web.util.formLoad("form1",url,"post",{bmz001:bmz001},function (data) {
            mini.get("bmz003").setValue(data.bmz003);
      })
    }
</script>
</html>
