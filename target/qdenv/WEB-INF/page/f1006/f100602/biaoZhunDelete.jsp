    ...
    <table  class="form-table">
        ...
        <tr>
            ...
            <td class="form-td-odd">
                <input id="bbz001"  name="bbz001" class="mini-textbox" value="${dto.bbz001}" visible="false"   />
                <input id="bbz002"  name="bbz002" class="mini-textbox" value="${dto.bbz002}" style="width:300px;" vtype="maxLength:100"  required="true"  />
            </td>
        </tr>
        <tr>
            <td class="form-td-even">
            ...
            <td class="form-td-odd">
                <input id="bbz003"  name="bbz003" class="mini-textbox" value="${dto.bbz003}" style="width:100px;"  />
            </td>
        </tr>
        <tr>
            <td class="form-td-even">
            ...
            <td class="form-td-odd">
                <input id="bbz004"  name="bbz004" class="mini-textbox" value="${dto.bbz004}" required="true" style="width:100px;"  />
            </td>
        </tr>
        <tr>
            <td class="form-td-even">
            ...
            <td class="form-td-odd">
                <input id="bmz003" class="mini-combobox" onvaluechanged="setWat002" textField="dictName" valueField="dictVal"
                       url="<%=request.getContextPath()%>/admin/queryRenderedAppDictDetails?dictCode=BMZ003" value="${dto.bmz003}" required="true" allowInput="true" nullItemText="请选择..."/>
        ...
        <tr>
            ...
            <td class="form-td-odd">
                <input id="aae013"  name="aae013" value="${dto.aae013}" class="mini-textbox" style="width:200px;"  />
            </td>
        </tr>
        <tr>
            <td></td>
            <td class="form-td-odd">
                ...
                <a class="mini-button" iconCls="icon-remove" id="doDelete" onclick="ondelete()">删除此标准</a>
            </td>
...
<script type="text/javascript">
    mini.parse();
    mini.get("bz04s").setValue('${dto.bhz001i}')
    function submitForm() {
    ...
    function ondelete() {
        var bbz001=mini.get("bbz001").getValue();
        Web.util.confirm("确定要删除？",function (action) {
            Web.util.request("<%=request.getContextPath()%>/work/f100602/saveBiaozhun",'post',{bbz001:bbz001,aae016:0},function () {
                mini.get("doDelete").disable();
            })
        });
    }
</script>
