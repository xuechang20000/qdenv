...
<div id="form1" >
    <table  class="form-table">
        ...
        <tr>
            ...
            <td class="form-td-odd">
                <input id="bbz003"  name="bbz003" class="mini-textbox" required="true" value="${dto.bbz003}" style="width:100px;"  />
            </td>
        </tr>
        <tr>
            <td class="form-td-even">
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        Web.util.confirm("确定要保存？",function (action) {
                //提交表单数据
                var url = '<%=request.getContextPath()%>/work/f100602/copyBiaozhun';
                var form = new mini.Form("#form1");
